...
export async function syncRoutes(app) {
    app.get("/catalog", async (req, reply) => {
        ...
        let recipeLines = recipeLinesVersioned;
        let recipeLineSizes = recipeLineSizesVersioned;
        let ingredients = ingredientsVersioned;
        ...
        return {
            ...
            items: items.map((i) => ({
                ...
                defaultSubstituteId: i.defaultSubstituteId ?? null,
                defaultSubstituteOptionId: i.defaultSubstituteOptionId ?? null,
