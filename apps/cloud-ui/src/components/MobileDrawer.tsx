...
export function MobileDrawer({ open, onClose }: MobileDrawerProps) {
  ...
  return (
    <>
      ...
      />
      <aside
        className="fixed left-0 top-0 z-40 flex h-full w-[280px] max-w-[85vw] flex-col bg-[#1f1f1f] shadow-xl md:hidden"
        style={{
      ...
      >
        <div className="flex flex-1 flex-col overflow-hidden">
          <div className="flex h-14 items-center justify-between border-b border-white/10 px-4">
            <span className="font-semibold text-teal-400">Dashboard</span>
            <button
              type="button"
              onClick={onClose}
