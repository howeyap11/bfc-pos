    ...
    async function handleSubmit(e) {
        ...
        try {
            if (mode === "create") {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].putItemOptionGroups(item.id, selectedModifierGroupIds);
                onSuccess?.();
            } else if (itemId) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].putItemOptionGroups(itemId, selectedModifierGroupIds);
                onSuccess?.();
            }
        } catch (err) {
            const body = err?.body;
...
//# sourceMappingURL=apps_cloud-ui_src_41ecaad5._.js.map