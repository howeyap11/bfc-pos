module.exports = [
"[project]/apps/cloud-ui/src/app/inventory/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function InventoryPage() {
    ...
    function refresh() {
        setLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getInventoryStock().then(setRows).catch((e)=>setError(e instanceof Error ? e.message : "Failed to load")).finally(()=>setLoading(false));
    }
...
//# sourceMappingURL=apps_cloud-ui_src_app_inventory_page_tsx_13868438._.js.map