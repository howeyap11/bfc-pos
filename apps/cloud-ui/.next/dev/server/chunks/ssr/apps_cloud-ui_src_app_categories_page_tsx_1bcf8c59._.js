module.exports = [
"[project]/apps/cloud-ui/src/app/categories/page.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function CategoriesPage() {
    ...
    function refresh() {
        setLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].getCategories().then((list)=>setCategories(Array.isArray(list) ? list : [])).catch((e)=>{
    ...
    async function handleCreateSub(categoryId, e) {
        ...
        setSaving(true);
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].createSubCategoryByCategory(categoryId, {
                name
            });
            setSubName((prev)=>({
                    ...prev,
    ...
    async function reorderCategory(cat, direction) {
        ...
        setError("");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].patchCategory(cat.id, {
                sortOrder: target.sortOrder
            });
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["api"].patchCategory(target.id, {
...
//# sourceMappingURL=apps_cloud-ui_src_app_categories_page_tsx_1bcf8c59._.js.map