...
"[project]/apps/cloud-ui/src/app/menu-settings/transaction-types/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function TransactionTypesPage() {
    _s();
    const [types, setTypes] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([]);
    ...
    function refresh() {
        setLoading(true);
        __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].getTransactionTypes().then(setTypes).catch((e)=>setError(e instanceof Error ? e.message : "Failed to load")).finally(()=>setLoading(false));
    }
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$1$2e$6_$40$babel$2b$core$40$7$2e$2_9d8d1bf7a8807769963b5151bd760c41$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "TransactionTypesPage.useEffect": ()=>{
            refresh();
        }
    }["TransactionTypesPage.useEffect"], []);
    ...
    async function handleSave() {
        ...
        setError("");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patchTransactionType(editingId, {
    ...
    async function handleToggleActive(t) {
        ...
        setError("");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].patchTransactionType(t.id, {
                isActive: !t.isActive
            });
            setSuccess("Updated");
            refresh();
    ...
    async function handleCreate(e) {
        ...
        setError("");
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].createTransactionType({
                label: newLabel.trim()
            });
            setSuccess("Added");
            setNewLabel("");
...
_s(TransactionTypesPage, "lxdq0SnrHLRb0PuGTBtzMwPxBBw=");
_c = TransactionTypesPage;
var _c;
__turbopack_context__.k.register(_c, "TransactionTypesPage");
...
//# sourceMappingURL=apps_cloud-ui_src_app_menu-settings_transaction-types_page_tsx_6e997ab7._.js.map