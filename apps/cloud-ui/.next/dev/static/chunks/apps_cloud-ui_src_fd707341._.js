            ...
            Promise.all([
                ...
                "ItemForm.useEffect": ([cats, ings, ingCats, item, recipe])=>{
                    ...
                    if (item) {
                        ...
                        const modifierLinks = links.filter({
                            "ItemForm.useEffect.modifierLinks": (l)=>!l.group?.isSizeGroup
                        }["ItemForm.useEffect.modifierLinks"]);
                        setModifierAssignments(modifierLinks.map({
                            "ItemForm.useEffect": (l)=>({
                                    groupId: l.groupId,
    ...
    async function handleSubmit(e) {
        ...
        try {
            if (mode === "create") {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].putItemOptionGroups(item.id, modifierAssignments.map((a)=>({
                        groupId: a.groupId,
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$apps$2f$cloud$2d$ui$2f$src$2f$lib$2f$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["api"].putItemOptionGroups(itemId, modifierAssignments.map((a)=>({
                        groupId: a.groupId,
                        isRequired: a.isRequired,
                        defaultOptionId: a.defaultOptionId
                    })));
...
_s1(ItemForm, "Cjo76oHyBsRN0HP/GryHBXno2OU=");
_c1 = ItemForm;
var _c, _c1;
...
//# sourceMappingURL=apps_cloud-ui_src_fd707341._.js.map